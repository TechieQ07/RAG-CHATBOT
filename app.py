...
Original file is located at
    https://colab.research.google.com/drive/1KHqd6c-lylWW1crcUwVKtmFX6ESS_202
"""
...
def create_conversational_chain(vector_store):
    ...
    if not hf_api_key:
        st.error("Hugging Face API key not found in environment. Please set HF_API_KEY in your .env file.")
        return None
...
def main():
    ...
    st.title("📄 Multi-Docs ChatBot (Retriever + Generator)")
